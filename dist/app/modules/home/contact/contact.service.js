...
const getAllContact = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
...
const getSingleContact = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield contact_model_1.Contact.findById({ _id: id }).lean();
    return result;
});
...
const deleteContact = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield contact_model_1.Contact.findByIdAndDelete({ _id: id });
    return result;
});
